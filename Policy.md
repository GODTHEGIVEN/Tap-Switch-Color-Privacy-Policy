...
Приложение также использует разрешение на функции:
(1) Вибрация,
(2) Использование интернет-трафика.
...
(1) информацию о трафике, другие типы данных для корректного показа
рекламы Google.
...
уточнения порядка обработки персональных данных в информационно-
